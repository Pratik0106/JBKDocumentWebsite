...
<tr>
<td>
<input type="text" name="sid" value="<%out.println(student.getSid()); %>" >
</td></tr>
<tr>

<td>Enter Name:-</td>
<td><input type="text" name="name" value="<%out.println(student.getName());%>"></td>

</tr>
<tr>
<td>Enter Address:-</td>
<td><input type="text" name="address" value="<%out.println(student.getAddress());%>"></td>
...
<td><input type="text" name="username" value="<%out.println(student.getUsername());%>"></td>

</tr>
<tr>
<td>Enter Password:-</td>
<td><input type="password" name="password" value="<%out.println(student.getPassword());%>"></td>
</tr>
<tr>
<td>Enter Status</td>
